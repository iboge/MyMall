    ...
    <form action="" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="" id="1" name="bname">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
						...
						<table class="table table-border table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.category}" var="category">
                                    <tr>
                                        <td><input name="aaa" type="checkbox" value="${category.id}"></td>
                                        <td>${category.name}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
        ...
        <div class="row cl">
            <div class="col-9 col-offset-3">
                <input class="btn btn-primary radius" name="tijiao" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
            </div>
        </div>
    </form>
</div>
