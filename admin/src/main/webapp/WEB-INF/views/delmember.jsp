...
<div class="page-container">
    <%--<div class="text-c"> 日期范围：
        ...
        -
        <input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d %H-%m-%s'})" id="datemax" class="input-text Wdate" style="width:120px;">
        &lt;%&ndash;<input type="text" class="input-text" style="width:250px" placeholder="输入会员名称、电话、邮箱" id="1" name="">&ndash;%&gt;
