...
<div class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span
                    ...
                    <select name="" class="select">
                        <c:forEach items="${requestScope.brand}"
                                   var="brand">
                            <option name="bid" value="${brand.id}">${brand.name}
                            </option>
                        </c:forEach>
                    </select>
                    </span> </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span
                    class="select-box">
                    <select name="b" class="select">
                        <c:forEach items="${requestScope.category}"
                                   var="category">
                            <option name="cid" value="${category.id}">${category.name}
                            </option>
                        </c:forEach>
                    </select>
                    </span> </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" name="inventory" id="7" placeholder=""
                       value="" class="input-text">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">图片上传：
            </label>
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-list-container">
                    ...
                    <div class="statusBar" style="display:none;">
                        <div class="progress"> <span
                                class="text">0%</span> <span class="percentage"></span> </div>
                        <div class="info"></div>
                        <div class="btns">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button<%-- onClick="article_save_submit();"--%> class="btn btn-primary radius" type="button" id="tijiao"><i class="Hui-iconfont">&#xe632;</i> 保存并提交</button>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#tijiao").click(function () {
            ...
            var bid = $("option[name='bid']:selected").val();
            var cid = $("option[name='cid']:selected").val();
    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '${path}/upload/fileUpload1',
                // runtimeOrder: 'flash',
