...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" href="${ctx}/product/addBrand"><i class="Hui-iconfont">&#xe600;</i> 添加品牌</a></span> <span class="r">共有数据：<strong>${requestScope.size}</strong> 条</span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="120">品牌所有分类</th>
                <th width="120">品牌添加时间</th>
                <th width="200">状态</th>
                <th width="100">操作</th>
            </tr>
            </thead>
                ...
                <tr class="text-c">
                    ...
                    <td>
                        <c:forEach items="${requestScope.bca}" var="bca">
                            <c:if test="${brand.name==bca.bname}">
                                <p>${bca.cname}</p>
                            </c:if>
                        </c:forEach>
                    </td>
                    ...
                    <c:if test="${brand.status==1}">
                        ...
                        <td class="td-manage">
                            <a href="${ctx}/product/queryBById?id=${brand.id}"><i class="Hui-iconfont">&#xe6df;</i></a>
                            <a style="text-decoration:none" onClick="member_stop(this,${brand.id})" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a></td>
                    </c:if>
                    <c:if test="${brand.status==0}">
                        <td class="td-status"><span class="label label-danger radius">已冻结</span></td>
                        <td class="td-manage">
                            <a href="${ctx}/product/queryBById?id=${brand.id}"><i class="Hui-iconfont">&#xe6df;</i></a>
                            <a style="text-decoration:none" href="javascript:;" onClick="member_start(this,${brand.id})" title="启用"><i class="Hui-iconfont">&#xe66b;</i></a></td>
                    </c:if>
                </tr>
            </c:forEach>
            </tbody>
