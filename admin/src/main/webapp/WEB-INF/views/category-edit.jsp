            ...
            <div class="tabCon">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="hidden" name="id" value="${requestScope.category.id}"/>
                        <input type="text" readonly="readonly" class="input-text" value="${requestScope.category.name}" placeholder="" id="1" name="bname">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <table class="table table-border table-bordered">
                            ...
                            <c:forEach items="${requestScope.brand}" var="brand">
                                <tr>
                                    <td><input name="aaa" type="checkbox" value="${brand.id}" <c:if test="${brand.checked == true}"> checked </c:if>/> </td>
                                    <td>${brand.name}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
