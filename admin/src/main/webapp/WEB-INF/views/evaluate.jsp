...
<div class="page-container">
    <%--<div class="text-c"> 日期范围：
        ...
        <input type="text" class="input-text" style="width:250px" placeholder="输入关键词" id="2" name="">
        <button type="submit" class="btn btn-success radius" id="1" name=""><i class="Hui-iconfont">&#xe665;</i> 搜意见</button>
    </div>--%>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="r">共有数据：<strong>${requestScope.size}</strong> 条</span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="60">ID</th>
                <th width="100">留言商品图</th>
                <th width="200">留言商品名</th>
                <th>留言内容</th>
                <%--<th width="100">操作</th>--%>
            </tr>
            </thead>
            ...
            <c:forEach items="${requestScope.evaluate}" var="evaluate">
                <tr class="text-c">
                    ...
                    <td>${evaluate.id}</td>
                    <td><a href="${evaluate.image}"><img alt="" style="width: 80px" src="${evaluate.image}"></a></td>
                    <td>${evaluate.pname}</td>
                    <td class="text-l"><div class="c-999 f-12">
                        <time>${evaluate.createtime}</time></div>
                        <div>${evaluate.evaluates}</div></td>
                    <%--<td class="td-manage"><a title="删除" href="javascript:;" onclick="member_del(this,${evaluate.id})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>--%>
                </tr>
            </c:forEach>
            <%--<tr class="text-c">
                <td><input type="checkbox" value="1" name=""></td>
